...
public class SimpleAutoTankDriveRobot extends IterativeRobot {
    ...
    public void robotInit() {
        // We could set up Strongback using its configurator, but this is
        // entirely optional since all defaults are acceptable.
    ...
    public void teleopInit() {
        // Starts Strongback if not already started; if it is, kill any commands
    ...
    public void disabledInit() {
        drive.stop();
        // Tell Strongback that the robot is disabled so it can flush all data
        // and kill all commands.
        Strongback.disable();
    }
