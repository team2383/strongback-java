...
public class Printer {
    ...
    /**
     * Sets the verbosity of this {@link Printer}. If {@code q} is set, no messages will be displayed. If {@code v} is set all
     * messages will be displayed. If {@code v} is not set, only messages with a verbosity of {@link Verbosity#ALWAYS} will be
     * displayed.
     *
