...
public class Parser {
    ...
    /**
     * String based argument parser, syntax information and arguments that require a parameter are specified as strings. Does
     * not handle any usage or help information, that should be printed elsewhere. Parses an array of GNU style command line
     * arguments and populates a {@link Map}. Arguments without a parameter (flags) are mapped to null. Arguments that do have a
     * parameter are mapped to that parameter.
     *
     * @param args arguments to parse
     * @param params a String list of arguments that require parameters {@code "abc"} means arguments a, b, and c all require
     *        parameters
     ...
     *        {@link InvalidParameterException} is thrown. Example: {@code "abc|d!e|e!d|fgh"} - a, b, and c are required, or d
     *        is required and e cannot be present, and so on.
